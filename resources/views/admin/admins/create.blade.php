<div class="layuimini-main">
    <form class="layui-form layuimini-form" method="post" action="{{ route('admin.admins.store') }}">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="nickname" lay-verify="required" lay-reqtext="{{ __('validation.required', ['attribute' => __('admin.nickname')]) }}" placeholder="{{ __('validation.placeholder', ['attribute' => __('admin.nickname')]) }}" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
