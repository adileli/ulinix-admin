...
<head>
    <meta charset="UTF-8">
    <title>{{ config('app.name', 'Ulinix') }}</title>
        ...
        <div class="layui-form login-form">
            <form class="layui-form" action="">
                <div class="layui-form-item logo-title">
                    <h1>{{ config('app.name', 'Ulinix') }}</h1>
                </div>
                <div class="layui-form-item">
                    <label class="layui-icon layui-icon-username" for="name"></label>
                    <input type="text" name="name" lay-verify="required|account" placeholder="{{ __('admin.name') }}" autocomplete="off" class="layui-input" value="{{ old('name') }}">
                </div>
                <div class="layui-form-item">
