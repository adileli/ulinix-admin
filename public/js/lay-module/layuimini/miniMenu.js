    ...
    var miniMenu = {
        ...
        render: function (options) {
            ...
            if (options.multiModule) {
                miniMenu.renderMultiModule(options.lang, options.menuList, options.menuChildOpen);
            } else {
                miniMenu.renderSingleModule(options.lang, options.menuList, options.menuChildOpen);
            }
            miniMenu.listen();
        },
         ...
         */
        renderSingleModule: function (lang, menuList, menuChildOpen) {
            menuList = menuList || [];
            var leftMenuHtml = '',
                childOpenClass = '',
            ...
            $.each(menuList, function (index, menu) {
                ...
                if (menu.child != undefined && menu.child != []) {
                    leftMenuHtml += '<a href="javascript:;" class="layui-menu-tips" ><i class="' + menu.icon + '"></i><span class="layui-left-nav"> ' + menu[titleName] + '</span> </a>';
                    var buildChildHtml = function (html, child) {
                        ...
                        $.each(child, function (childIndex, childMenu) {
                            ...
                            if (childMenu.child != undefined && childMenu.child != []) {
                                html += '<a href="javascript:;" class="layui-menu-tips" ><i class="' + childMenu.icon + '"></i><span class="layui-left-nav"> ' + childMenu[titleName] + '</span></a>';
                                html = buildChildHtml(html, childMenu.child);
                            } else {
                                html += '<a href="javascript:;" class="layui-menu-tips"  layuimini-href="' + childMenu.href + '" target="' + childMenu.target + '"><i class="' + childMenu.icon + '"></i><span class="layui-left-nav"> ' + childMenu[titleName] + '</span></a>\n';
                            }
                            html += '</dd>\n';
                        });
                        html += '</dl>\n';
                    ...
                    leftMenuHtml += '<a href="javascript:;" class="layui-menu-tips"  layuimini-href="' + menu.href + '" target="' + menu.target + '"><i class="' + menu.icon + '"></i><span class="layui-left-nav"> ' + menu[titleName] + '</span></a>\n';
                }
                leftMenuHtml += '</li>\n';
            });
            leftMenuHtml += '</ul>\n';
         ...
         * @param menuChildOpen 是否默认展开
         */
        renderMultiModule: function (lang, menuList, menuChildOpen) {
            menuList = menuList || [];
            var headerMenuHtml = '',
            ...
            $.each(menuList, function (key, val) {
                ...
                headerMenuHtml += '<li class="layui-nav-item ' + headerMenuCheckDefault + '" id="' + key + 'HeaderId" data-menu="' + key + '"> <a href="javascript:;"><i class="' + val.icon + '"></i> ' + val[titleName] + '</a> </li>\n';
                headerMobileMenuHtml += '<dd><a href="javascript:;" id="' + key + 'HeaderId" data-menu="' + key + '"><i class="' + val.icon + '"></i> ' + val[titleName] + '</a></dd>\n';
