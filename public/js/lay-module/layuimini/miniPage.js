...
layui.define(["element", "jquery"], function (exports) {
    ...
    var miniPage = {
        ...
        renderPageTitle: function (href, options) {
            ...
            var pageTitleArray = miniPage.buildPageTitleArray(href, options.menuList, lang);
         ...
         * @param lang
         */
        buildPageTitleArray: function (href, menuList, lang) {
            var array = [],
                newArray = [],
            ...
            for (key in menuList) {
                ...
                if (item.href === href) {
                    array.push(item[titleName]);
                    break;
                }
                if (item.child) {
                    newArray = miniPage.buildPageTitleArray(href, item.child, lang);
                    if (newArray.length > 0) {
                        newArray.unshift(item[titleName]);
